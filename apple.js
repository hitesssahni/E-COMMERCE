...
let sortby_opt = document.querySelector(".sortby_opt");
  ...
  .then((data) => {
    ...
    loafers.addEventListener("click", () => {
      if (loafers.title === "loafers_filter_on") {
        ...
        loafers.title = "loafers_filter-off";
    ...
    right_input.addEventListener("change", () => {
      right_input_icon.style.right = right_input.value + "%";
      // console.log(left_input.value+'%');
      ...
      let array_5001_100000 = all_shoes_array.filter((el) => {
        return el.Price >= 50000;
      });

      let array_50000_50000_right = array_50001_100000.filter((el) => {
